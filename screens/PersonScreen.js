                ...
                <View>
                    ...
                    <View className="mx-3 p-4 mt-6 flex-row justify-between items-center bg-neutral-700 rounded-full ">
                        <View className="border-r-2 border-r-neutral-400 px-2 items-center">
                            <Text className="text-white font-semibold ">Género</Text>
                        ...
                        <View className="border-r-2 border-r-neutral-400 px-2 items-center">
                            <Text className="text-white font-semibold">Puesto</Text>
                            <Text className="text-neutral-300 text-sm">
                                {/* Acting */}
                    ...
                    <View className="my-6 mx-4 space-y-2">
                        <Text className="text-white text-lg">Biografía</Text>
                    ...
                    {/* person movies */}
                    { person?.id && personMovies.length>0 && <MovieList title="Películas" hideSeeAll={true} data={personMovies} /> }
